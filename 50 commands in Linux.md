...
22.     sudo dnf update
  ...
  Command 'sudo dnf update atau sudo apt update' digunakan untuk memperbarui paket di sistem menggunakan manajer paket DNF (Dandified Yum) di distribusi Linux Fedora dan sejenisnya. Lalu pada 'sudo apt' digunakan pada sistem operasi seperti Ubuntu atau linux yang lainnya.
